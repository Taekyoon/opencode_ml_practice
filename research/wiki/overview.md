...
- **데이터셋**: `lab_sensor_data` (5,000행, failure 비율 **16.98%**, 특성 8개) → [datasets/lab_sensor_data.md](datasets/lab_sensor_data.md)
- **태스크 수**: 2 (분류 1 + 회귀 1) → [tasks/](tasks/)
...
3. 교차 태스크 교훈/다음 방향 → [synthesis/lessons_learned.md](synthesis/lessons_learned.md)
4. 실험 후 이 wiki 갱신 (tasks/ 페이지 반영)
