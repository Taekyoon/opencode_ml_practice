...
|--------|------|----------|-----------|------|
| failure_prediction | 분류 | 8 | **0.7912** | 베이스라인만 반복 |
| quality_regression | 회귀 | 6 | **0.9822** | 베이스라인만 반복 |
| prompt_guard | 분류 | 1 | **1.0** (hard_eval 0.42) | 카테고리 수준 완벽 — 하드 케이스 한계 |
| wafer_vision | 분류 | 1 | **0.8357** (합성) / 0.2369 (WM-811K) | 실데이터 첫 실행 — 튜닝 여지 큼 |
