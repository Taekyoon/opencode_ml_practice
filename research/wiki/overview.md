...
- **데이터셋**: `lab_sensor_data` (5,000행, failure 비율 **16.98%**, 특성 8개), `wm811k` (웨이퍼맵 811,457행, 라벨 172,950) → [datasets/](datasets/)
- **태스크 수**: 3 (분류 2 + 회귀 1) → [tasks/](tasks/)
...
4. 교차 태스크 교훈/다음 방향 → [synthesis/lessons_learned.md](synthesis/lessons_learned.md)
5. 실험 후 이 wiki 갱신 (tasks/ 페이지 반영)
