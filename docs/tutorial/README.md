...
| 레슨 | 제목 | 배우는 것 | 시간 |
|------|------|----------|------|
| [J1](J_agent_evolution/31_execution_events.md) | 실행 이벤트 기록 | 실패도 기록하는 이벤트 테이블 | 25분 |
| [J2](J_agent_evolution/32_validation_gate.md) | 검증 게이트 | 점수만으로 판단하지 않는 법 | 25분 |
| [J3](J_agent_evolution/33_propose_validate_apply.md) | 제안→검증→적용 | 변경 근거(`_rationale`)와 검증 루프 | 30분 |
